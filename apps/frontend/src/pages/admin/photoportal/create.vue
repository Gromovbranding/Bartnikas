...
import type { IPhotoportal, IPhotoportalTranslate, PartialAdminApiDto } from '~/types/admin-api'
...
const form = reactive<PartialAdminApiDto<IPhotoportal>>({
  is_active: false,
...
<template>
  ...
  >
    <AdminTemplateForm ref="formRef" :model="form" :rules="formRules">
      ...
      <ElFormItem
        :label="'Influence quote text'"
        :prop="`translate.${currentIndexLocale}.influence_quote_text`"
      >
        <ElInput v-model="form.translate[currentIndexLocale].influence_quote_text" type="textarea" />
      </ElFormItem>
      <ElFormItem
        :label="'Influence quote accent text'"
        :prop="`translate.${currentIndexLocale}.influence_quote_accent_text`"
      >
        <ElInput v-model="form.translate[currentIndexLocale].influence_quote_accent_text" type="textarea" />
      </ElFormItem>
      <ElFormItem
